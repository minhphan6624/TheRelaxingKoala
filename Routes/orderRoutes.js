...
router.get('/orders/:id/items', orderController.getOrderWithItems); // Route to get an order by ID with items
...
router.delete('/orders/items/:itemId', orderController.removeOrderItem);
